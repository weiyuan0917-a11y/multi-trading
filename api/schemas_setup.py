...
class SetupAccountRegisterBody(BaseModel):
    ...
    fosun_api_key: Optional[str] = None
    fosun_base_url: Optional[str] = None
    fosun_sub_account_id: Optional[str] = None
    fosun_client_id: Optional[str] = None
    fosun_server_public_key: Optional[str] = None
    fosun_client_private_key: Optional[str] = None
    fosun_sdk_type: Optional[str] = None
    fosun_apply_account_id: Optional[str] = None
    fosun_option_apply_account_id: Optional[str] = None
    longport_app_key: Optional[str] = None
    longport_app_secret: Optional[str] = None
    longport_access_token: Optional[str] = None
...
class SetupStopAllBody(BaseModel):
    ...
    stop_stock_options_swing: bool = True
