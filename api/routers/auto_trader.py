...
def auto_trader_template_preview(
    ...
    identity = require_entitlement(authorization, x_local_owner, "stock_auto_trading", x_api_key)
    return rt.auto_trader_template_preview(name=name, owner_id=identity.owner_id)


@router.get("/auto-trader/config/export")
def auto_trader_export_config(
    authorization: str | None = Header(default=None),
    x_local_owner: str | None = Header(default=None, alias="X-MT-Local-Owner"),
    x_api_key: str | None = Header(default=None, alias="X-Api-Key"),
) -> dict[str, Any]:
    identity = require_entitlement(authorization, x_local_owner, "stock_auto_trading", x_api_key)
    return rt.auto_trader_export_config(owner_id=identity.owner_id)
...
def auto_trader_config_backups(
    authorization: str | None = Header(default=None),
    x_local_owner: str | None = Header(default=None, alias="X-MT-Local-Owner"),
    x_api_key: str | None = Header(default=None, alias="X-Api-Key"),
) -> dict[str, Any]:
    identity = require_entitlement(authorization, x_local_owner, "stock_auto_trading", x_api_key)
    return rt.auto_trader_config_backups(owner_id=identity.owner_id)
...
def auto_trader_config_rollback_preview(
    backup_id: str,
    authorization: str | None = Header(default=None),
    x_local_owner: str | None = Header(default=None, alias="X-MT-Local-Owner"),
    x_api_key: str | None = Header(default=None, alias="X-Api-Key"),
    ...
    identity = require_entitlement(authorization, x_local_owner, "stock_auto_trading", x_api_key)
    return rt.auto_trader_config_rollback_preview(backup_id=backup_id, owner_id=identity.owner_id)
...
def auto_trader_signals(
    ...
    try:
        ...
        owner_id = str(x_local_owner or "").strip().lower() or None
    return rt.auto_trader_signals(status=status, owner_id=owner_id)
...
def auto_trader_confirm(
    ...
    identity = require_entitlement(authorization, x_local_owner, "stock_auto_trading", x_api_key)
    return rt.auto_trader_confirm(signal_id=signal_id, body=body, owner_id=identity.owner_id)
