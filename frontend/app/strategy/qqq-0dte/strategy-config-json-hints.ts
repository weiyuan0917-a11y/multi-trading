...
export const STRATEGY_CONFIG_FIELD_HINTS: Record<string, string> = {
  strategy_variant: "策略变体：reaction_zone 反应区 / morning_strangle 早盘宽跨 / morning_double_strangle 早盘双宽跨 / morning_directional 早盘方向单 / gamma_scalping / gamma_pro",
  ...
  double_strangle_call_long_strikes_otm: "双宽跨：Call 长腿 OTM 档数，必须大于 Call 短腿",
  double_strangle_call_short_strikes_otm: "双宽跨：Call 短腿 OTM 档数",
  double_strangle_put_long_strikes_otm: "双宽跨：Put 长腿 OTM 档数，必须大于 Put 短腿",
  double_strangle_put_short_strikes_otm: "双宽跨：Put 短腿 OTM 档数",
  double_strangle_call_long_leg_take_profit_pct: "双宽跨：Call 长腿单腿止盈比例",
  double_strangle_call_short_leg_take_profit_pct: "双宽跨：Call 短腿单腿止盈比例",
  double_strangle_put_long_leg_take_profit_pct: "双宽跨：Put 长腿单腿止盈比例",
  double_strangle_put_short_leg_take_profit_pct: "双宽跨：Put 短腿单腿止盈比例",
  double_strangle_single_leg_stop_loss_pct: "双宽跨：单腿止损比例，不区分长短腿",
  double_strangle_combo_take_profit_pct: "双宽跨：四腿组合止盈比例",
  double_strangle_combo_stop_loss_pct: "双宽跨：四腿组合止损比例；0 表示关闭",
  double_strangle_max_total_debit: "双宽跨：四腿总权利金上限；0 表示不限制",
  double_strangle_require_all_legs_filled: "双宽跨：是否要求四条腿全部成交后才进入持仓状态",
