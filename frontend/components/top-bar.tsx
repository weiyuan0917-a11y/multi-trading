...
function routeTitle(pathname: string | null) {
  ...
  if (path.startsWith("/auto-trading/options-1dte")) return "股票期权日内交易";
  if (path.startsWith("/auto-trading/options-swing")) return "股票期权中长线交易";
    ...
    <header className="topbar">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        ...
        <div className="min-w-0">
          <div className="text-xs font-medium text-slate-500">MultiTrading</div>
