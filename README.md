...
<p align="center">
  <strong><a href="https://github.com/weiyuan0917-a11y/multi-trading/releases/tag/V1.0.43">下载 Windows 安装包：MultiTradingSetup-1.0.43.exe</a></strong>
  <br />
  <a href="./CHANGELOG.md">更新日志 / Changelog</a>
  <br />
  当前源码与客户版构建脚本版本：V1.0.43（安装包发布后更新 Release 下载链接）
</p>
