...
Side = Literal["long_call", "long_put", "strangle", "double_strangle"]
...
class OpenPosition:
    ...
    # Morning double strangle: four legs keyed by
    # call_long/call_short/put_long/put_short.
    double_strangle_legs: dict[str, dict[str, Any]] = field(default_factory=dict)
