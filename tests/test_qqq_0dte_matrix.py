...
class TestQqq0dteMatrixGrid(unittest.TestCase):
    ...
    def test_ui_percent_fields(self) -> None:
        ...
        apply_grid_to_strategy_dict(cfg, "double_strangle_combo_take_profit_pct_ui", 60)
        self.assertAlmostEqual(cfg["double_strangle_combo_take_profit_pct"], 0.60)
        apply_grid_to_strategy_dict(cfg, "double_strangle_combo_stop_loss_pct_ui", 30)
        self.assertAlmostEqual(cfg["double_strangle_combo_stop_loss_pct"], 0.30)
        apply_grid_to_strategy_dict(cfg, "double_strangle_single_leg_stop_loss_pct_ui", 35)
        self.assertAlmostEqual(cfg["double_strangle_single_leg_stop_loss_pct"], 0.35)
        apply_grid_to_strategy_dict(cfg, "double_strangle_call_long_leg_take_profit_pct_ui", 100)
        self.assertAlmostEqual(cfg["double_strangle_call_long_leg_take_profit_pct"], 1.0)
        apply_grid_to_strategy_dict(cfg, "double_strangle_call_short_leg_take_profit_pct_ui", 35)
        self.assertAlmostEqual(cfg["double_strangle_call_short_leg_take_profit_pct"], 0.35)

    def test_double_strangle_strikes_otm_int(self) -> None:
        cfg: dict = {}
        apply_grid_to_strategy_dict(cfg, "double_strangle_call_long_strikes_otm", 3.0)
        apply_grid_to_strategy_dict(cfg, "double_strangle_call_short_strikes_otm", 1.0)
        apply_grid_to_strategy_dict(cfg, "double_strangle_put_long_strikes_otm", 3.0)
        apply_grid_to_strategy_dict(cfg, "double_strangle_put_short_strikes_otm", 1.0)

        self.assertEqual(cfg["double_strangle_call_long_strikes_otm"], 3)
        self.assertEqual(cfg["double_strangle_call_short_strikes_otm"], 1)
        self.assertEqual(cfg["double_strangle_put_long_strikes_otm"], 3)
        self.assertEqual(cfg["double_strangle_put_short_strikes_otm"], 1)
