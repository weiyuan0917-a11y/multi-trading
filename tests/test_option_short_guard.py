...
def test_vertical_spread_close_requires_sell_leg_broker_position():
    result = validate_option_sell_covered(
        legs=[
            {"symbol": "AAPL260619C00210000", "side": "buy", "contracts": 1},
            {"symbol": "AAPL260619C00200000", "side": "sell", "contracts": 1},
        ],
        positions=[{"symbol": "AAPL260619C00200000", "quantity": 1}],
    )
...
def test_vertical_spread_open_can_use_same_order_cover_without_position():
    result = validate_option_sell_covered(
        legs=[
            {"symbol": "AAPL260619C00210000", "side": "buy", "contracts": 1},
            {"symbol": "AAPL260619C00200000", "side": "sell", "contracts": 1},
...
def test_same_order_cover_does_not_hide_oversized_close_sell():
    result = validate_option_sell_covered(
        legs=[
            {"symbol": "AAPL260619C00210000", "side": "buy", "contracts": 1},
            {"symbol": "AAPL260619C00200000", "side": "sell", "contracts": 2},
        ],
        positions=[{"symbol": "AAPL260619C00200000", "quantity": 1}],
    )
